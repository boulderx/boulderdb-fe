...
export default function ClimbersOverview({token}){
                    ...
                    <Table sx={{ minWidth: 700 }} aria-label="customized table">
                            ...
                            <TableRow>
                                ...
                                <StyledTableCell align="right">
                                    <Button
                                        type="button"
                                        variant="contained"
                                        onClick={() => changeNavHandler('/climbers/new')}
                                    >
                                        Create New
                                    </Button>
                                </StyledTableCell>
                        ...
                        <TableBody>
                            {climbers ? (climbers.map((climber) => (
                                <StyledTableRow key={climber._id}>
                                    <StyledTableCell>
                                        {climber.firstName}
                                    </StyledTableCell>
                                    <StyledTableCell>{climber.lastName}</StyledTableCell>
                                    <StyledTableCell align="right">
                                        <IconButton onClick={() => changeNavHandler(`/climbers/${climber._id}`)}>
                                            <EditIcon />
                                        </IconButton>
                                        {/*<IconButton>
                                            <DeleteIcon />
